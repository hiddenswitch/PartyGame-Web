...
Meteor.startup(function () {
    ...
    Meteor.setInterval(function () {
        Games.update({open: true, $or: [
            {modified: {$lt: new Date().getTime() - K_HEARTBEAT * 10000}},
            {questionCardsCount: {$lt: 1}},
            {answerCardsCount: {$lt: 1}}
        ]}, {$set: {open: false}}, {multi: true}, function (e) {
            if (e) {
                console.log(e);
            }
        });
